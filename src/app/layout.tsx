...
export const metadata: Metadata = {
  ...
  description: "Free AI-powered posture monitoring app that detects slouching and helps you maintain perfect posture while working. Privacy-first, works offline.",
...
export default function RootLayout({
  ...
  const structuredData = {
    ...
    "@type": "WebApplication",
    "name": "SlouchDetector",
    "description": "AI-powered posture monitoring app that detects slouching and helps maintain perfect posture while working",
    "url": "https://slouchdetector.net",
